...
namespace LeaveManagement.BusinessLogic.Repositories
{
    public class LeaveAllocationRepository : GenericRepository<LeaveAllocation>, ILeaveAllocationRepository
    {
        ...
        public async Task LeaveAllocation(int leaveTypeId)
        {
            ...
            var employeeNewAllocation = new List<Employee>();
            ...
            foreach(var employee in employees)
            {
                ...
                employeeNewAllocation.Add(employee);
            }
            await AddRangeAsync(allocations);

            foreach(var employee in employeeNewAllocation)
            { 
                await emailSender.SendEmailAsync(employee.Email, $"Leave Allocation for period {period}", $"Your {leaveType.Name} leave " +
